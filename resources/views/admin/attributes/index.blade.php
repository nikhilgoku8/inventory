            ...
            <div class="page-header my_style">
                ...
                <div class="right_section">
                    <div class="purple_hollow_btn">
                        <a href="{{ route('admin.attributes.create'); }}">Add New</a>
                    </div>
    ...
    <div class="row">
        <div class="fourth_row">
            ...
            <div class="my_panel">
                ...
                <div class="upper_sec">
                    <div class="left_section">
                        <div class="title">Attributes Data</div>
                            ...
                            @if(!empty($result))
                                @foreach ($result as $row)
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="{{ route('admin.attributes.edit', $row->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                            <span class="checkbox">
  ...
  $("#delete_records").on('click',(function(e){
    ...
    if(dataID.length == 0){
        ...
        if (confirm('Are you sure you want to delete these records?')) {
            $.ajax({
                type: "POST",
                url: "{{ route('admin.attributes.bulk-delete') }}",
