                ...
                <div class="page-header my_style less_margin">
                    <div class="left_section">
                        <div class="title_text">
                            <div class="title">Edit Attribute</div>
                    ...
                    <div class="input_boxes">
                        ...
                        <div class="col-sm-12">
                            <div class="input_box">
                                ...
                                <input type="number" name="sort_order" placeholder="Sort_Order" value="{{ $result->sort_order }}">
                            </div>
                        </div>
                        <div class="clr"></div>
                    </div>
...
$(document).ready(function() {
    ...
    $("#data_form").on('submit',(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.attributes.update', $result->id) }}",
            data:  formData,
            dataType: 'json',
            cache: false,
            contentType: false,
            ...
            success: function(result) {
                location.href="{{ route('admin.attributes.index') }}";
            },
            error: function(data){
